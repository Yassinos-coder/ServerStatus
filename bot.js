...
exports.start = function(SETUP) {
    ...
    const UpdateEmbed = function() {
        ...
        let embed = new Discord.RichEmbed()
            .setAuthor("ALPHΛ-X-RP Server Status", "https://cdn.discordapp.com/attachments/573916874925015051/578109302007660575/unknown.png")
            .setColor(0x2894C2)
            .setFooter(TICK_N % 2 === 0 ? '⚪ ALPHΛ-X-RP' : '⚫ ALPHΛ-X-RP')
            .setTimestamp(new Date())
            .addField('\n\u200b\nComment pouvez-vous rejoindre le serveur ?', 'Vous pouvez rejoindre le serveur via [WebSite](https://alphagamingcommunity.000webhostapp.com) à saisir sur Direct Connect. En bas se trouve l\'état du serveur pour voir combien de personnes sont en ligne et qui sont dans la file d\'attente. Ce système est réalisé par [Douile](https://github.com/Douile/) et optimisé par [Yassinos](https://github.com/Yassinos-coder). \n\u200b\n', false)
        if (STATUS !== undefined) {
    ...
    const offline = function() {
        ...
        let embed = UpdateEmbed()
            ...
            .addField('File d\'attente', '?', true)
            .addField('Joueurs en ligne', '?\n\u200b\n', true);
        sendOrUpdate(embed);
        LAST_COUNT = null;
    };
        ...
        getVars().then((vars) => {
            getPlayers().then((players) => {
                ...
                let embed = UpdateEmbed()
                    ...
                    .addField('File d\'attente', queue === 'Enabled' || queue === undefined ? '0' : queue.split(':')[1].trim(), true)
                    .addField('Joueurs en ligne', `${players.length}/${MAX_PLAYERS}\n\u200b\n`, true);
                // .addField('\u200b','\u200b\n\u200b\n',true);
                if (players.length > 0) {
                    // method D
                    const fieldCount = 3;
    ...
    bot.on('ready', () => {
        ...
        bot.user.setActivity('Alpha Players', { 'url': 'https://alphagamingcommunity.000webhostapp.com/', 'type': 'WATCHING' });
